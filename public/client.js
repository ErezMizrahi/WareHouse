    ...
    const API_URL = window.location.href == 'localhost' ? "http://localhost:5500/items" : 'https://itamar-locks.vercel.app/items'
    const API_URL_SEARCH =  window.location.href == 'localhost' ? "http://localhost:5500/searchItems": 'https://itamar-locks.vercel.app/searchItems'
    const API_URL_EXCEL =  window.location.href == 'localhost' ? "http://localhost:5500/excel": 'https://itamar-locks.vercel.app/excel'
    const API_URL_UPDATE =  window.location.href == 'localhost' ? "http://localhost:5500/update/": 'https://itamar-locks.vercel.app/update'
    ...
    function createCardElement(item /*, count */) {
        ...
        var modalBody = document.getElementById('exampleModal').children[0].children[0].children[0].children[0];
